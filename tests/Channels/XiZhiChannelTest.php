 ...
 * @small
 */
class XiZhiChannelTest extends TestCase
{
    public function testCreateMessage(): void
    {
        $channel = $this->app->make(ExceptionNotifyManager::class)->driver('xiZhi');
        $this->assertInstanceOf(XiZhiChannel::class, $channel);
